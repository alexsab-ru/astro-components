...
| VDSina, прежний GitHub Pages proxy | `auto-team.pro` | nginx proxy | Перенос не завершён: workflow остаётся `pending` без jobs, Pages не отключён |
