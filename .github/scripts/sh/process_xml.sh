...
handle_update() {
    ...
    case $type in
        ...
        "data_cars_car")
            ...
            ;;
        "used_cars_data_cars_car")
            python3 .github/scripts/update_cars.py --source_type data_cars_car --skip_thumbs --repo_name="$DOMAIN" --cars_dir="src/content/used_cars" --output_path="./public/used_cars.xml"
            ;;
        "maxposter")
