      ...
      numericKeys.forEach(key => {
        if (car[key] !== undefined) {
          ...
          if (car[key+'Disclaimer'] && car[key+'Disclaimer'] !== '' && car[key+'Disclaimer'] !== null) {
            carsPlaceholder[`{{${key}b-${car.id}}}`] += quoteEscaper(`<span class="ui-disclaimer"><span class="ui-disclaimer-icon">i</span><span class="ui-disclaimer-text">${car[key+'Disclaimer']}</span></span>`);
          }
