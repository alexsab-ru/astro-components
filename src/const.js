...
export const AGREE_LABEL = '<span>Я согласен на</span> <a href="/privacy-policy" class="!m-0 underline transition-all hover:no-underline xs:text-sm xs:block" target="_blank">обработку персональных данных</a>';
