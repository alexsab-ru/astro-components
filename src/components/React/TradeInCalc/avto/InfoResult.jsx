...
function AvtoInfoResult() {
	...
	return ( 
		<>
			...
			<div className="flex flex-wrap justify-between items-center gap-5 text-gray-600 font-medium py-10 px-6 border-b border-b-gray-300 mb-12">
				{selfSale !== 0 ? (
					<div>
						<p className="font-bold !mb-2">{ selfSale.toLocaleString('ru-RU') }&nbsp;₽</p>
						<p className="m-0">при самостоятельной продаже</p>
					</div>
				) : (
					<p className="!mb-0">К сожалению, по указанным параметрам сделать расчет не удалось</p>
				)}
				<button
			...
			<div className="pb-4 px-6">
				<p className="text-gray-600">
					<sup>*</sup> Указанная расчетная стоимость является приблизительной и&nbsp;действует при выкупе автомобиля с&nbsp;пробегом. Информация предоставлена <a href="https://maxposter.ru" target="_blank" className="">MaxPoster</a>.
				</p>
			</div>
